        ...
        <div className="bg-background text-foreground">
            ...
            <section className="relative py-20 md:py-32 bg-gradient-to-r from-[#0f172a] to-[#334155] text-white">
                <div className="container mx-auto px-4 md:px-6 text-center">
                    <h1 className="text-4xl md:text-6xl font-bold">Healthcare & Pharmaceuticals</h1>
                    <p className="mt-4 text-lg md:text-xl text-gray-300 max-w-3xl mx-auto">Providing specialized IT solutions for the healthcare and pharmaceutical industries, ensuring compliance, security, and innovation.</p>
                </div>
            </section>
            ...
            <section className="py-20 md:py-24 bg-gradient-to-r from-slate-500 to-slate-400 text-white">
                <div className="container mx-auto px-4 md:px-6">
                    <div className="text-center mb-12">
                        ...
                        <p className="mt-2 text-slate-200">The principles that guide our work in the health sector.</p>
                    </div>
            ...
            <section className="py-20 md:py-24 bg-gradient-to-r from-[#0f172a] to-[#334155] text-white">
                <div className="container mx-auto px-4 md:px-6">
                    <PricingToggle tiers={pricingTiers} supportFeatures={supportFeatures}>
                        <h2 className="text-4xl md:text-5xl font-bold">HealthTech Solution Plans</h2>
                        <p className="text-gray-300">Choose a plan that fits your practice or organization's needs. We offer scalable solutions for the healthcare industry.</p>
                    </PricingToggle>
                </div>
            </section>
                ...
                <div className="container mx-auto px-4 md:px-6">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="flex flex-col space-y-8">
                            <div>
                                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-gray-800">Free Consultation - Discover HealthTech Solutions</h2>
