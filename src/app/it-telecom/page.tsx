        ...
        <div className="bg-background text-foreground">
            ...
            <section className="relative py-20 md:py-32 bg-gradient-to-r from-[#0f172a] to-[#334155] text-white">
                <div className="container mx-auto px-4 md:px-6 text-center">
                    <h1 className="text-4xl md:text-6xl font-bold">Information Technology & Telecommunications</h1>
                    <p className="mt-4 text-lg md:text-xl text-gray-300 max-w-3xl mx-auto">Providing robust IT and telecommunications solutions to keep your business connected and secure.</p>
                </div>
            </section>
            ...
            <section className="py-20 md:py-24 bg-gradient-to-r from-slate-500 to-slate-400 text-white">
                <div className="container mx-auto px-4 md:px-6">
                    <div className="text-center mb-12">
                        ...
                        <p className="mt-2 text-slate-200">The principles that guide our work and our commitment to you.</p>
                    </div>
            ...
            <section className="py-20 md:py-24 bg-gradient-to-r from-[#0f172a] to-[#334155] text-white">
                <div className="container mx-auto px-4 md:px-6">
                    <PricingToggle tiers={pricingTiers} supportFeatures={supportFeatures}>
                        <h2 className="text-4xl md:text-5xl font-bold">Flexible IT & Telecom Plans</h2>
                        <p className="text-gray-300 mt-2 max-w-2xl mx-auto">Choose a plan that fits your business needs. We offer scalable solutions for businesses of all sizes.</p>
                    </PricingToggle>
                </div>
            </section>
                ...
                <div className="container mx-auto px-4 md:px-6">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="flex flex-col space-y-8">
                            <div>
                                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-gray-800">Free Consultation - Optimize Your Technology</h2>
