...
const MarqueeItem = ({ text }: { text: string }) => (
    <div className="flex items-center space-x-4">
        ...
        <Image src="/Xlogo.svg" alt="SulzaX Logo" width={120} height={32} className="brightness-0 invert shrink-0" />
    </div>
);
          ...
          <div className="grid gap-6 md:grid-cols-2 md:gap-12 items-center">
            <div className="flex flex-col justify-center space-y-4 text-center md:text-left">
              <div className="space-y-2">
                <h1 className="text-4xl font-bold tracking-tighter text-white sm:text-5xl lg:text-6xl/none">
                  Transform Your Business with Custom IT Solutions
                </h1>
                <p className="max-w-[600px] text-gray-300 text-base sm:text-lg md:text-xl mx-auto md:mx-0">
        ...
        <div className="container mx-auto px-4 md:px-6">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                    <Badge variant="outline" className="bg-accent/10 text-accent font-semibold border-accent/20">AI-POWERED</Badge>
                    <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-white">Get Instant IT Solution Recommendations</h2>
                    ...
                    <ul className="space-y-3">
                        <li className="flex items-center gap-3">
                         ...
                         <li className="flex items-center gap-3">
                            <CheckCircle className="w-5 h-5 text-accent" />
                            <span className="text-gray-300">Based on successful projects</span>
                        </li>
                    </ul>
                </div>
                <AiSolutionAdvisor />
