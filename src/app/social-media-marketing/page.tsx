        ...
        <div className="bg-background text-foreground">
            ...
            <section className="relative py-20 md:py-32 bg-gradient-to-r from-[#0f172a] to-[#334155] text-white">
                <div className="container mx-auto px-4 md:px-6 text-center">
                    ...
                    <p className="mt-4 text-lg md:text-xl text-gray-300 max-w-3xl mx-auto">Building brand awareness, driving engagement, and generating leads through strategic social media campaigns.</p>
                </div>
            </section>
            ...
            <section className="py-20 md:py-24 bg-gradient-to-r from-slate-500 to-slate-400 text-white">
                <div className="container mx-auto px-4 md:px-6">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold">Our Social Media Values</h2>
                        <p className="mt-2 text-slate-200">The principles that guide our social media strategies.</p>
                    </div>
            ...
            <section className="py-20 md:py-24 bg-gradient-to-r from-[#0f172a] to-[#334155] text-white">
                <div className="container mx-auto px-4 md:px-6">
                    <PricingToggle tiers={pricingTiers} supportFeatures={supportFeatures}>
                        <h2 className="text-4xl md:text-5xl font-bold">Ignite Your Social Media Presence</h2>
                        <p className="text-gray-300 mt-2 max-w-2xl mx-auto">Choose a social media package that fits your needs. We offer transparent pricing for businesses of all sizes.</p>
                    </PricingToggle>
                </div>
            </section>
                 ...
                 <div className="container mx-auto px-4 md:px-6">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="flex flex-col space-y-8">
                            <div>
                                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-gray-800">Free Consultation - Discover Your Social Strategy</h2>
