    ...
    <footer className="bg-white text-black border-t border-gray-200">
      <div className="container py-16 md:py-20 text-sm">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-600 max-w-sm">
             ...
             <div className="space-y-2 text-gray-600">
                <p className="flex items-center gap-2"><Clock className="w-4 h-4 text-black" /> Mon - Fri: 9:00 - 19:00</p>
                <p className="flex items-center gap-2"><PowerOff className="w-4 h-4 text-black" /> Closed on Weekends</p>
             </div>
          </div>
          
          <div>
            <h4 className="font-semibold mb-4 text-base text-black">Company</h4>
            <ul className="space-y-3">
              <li><Link href="/about" className="text-gray-600 hover:text-black transition-colors">About Us</Link></li>
              <li><Link href="/team" className="text-gray-600 hover:text-black transition-colors">Our Team</Link></li>
              <li><Link href="/services" className="text-gray-600 hover:text-black transition-colors">Services</Link></li>
              <li><Link href="/portfolio" className="text-gray-600 hover:text-black transition-colors">Case Studies</Link></li>
          ...
          <div>
            <h4 className="font-semibold mb-4 text-base text-black">Solutions</h4>
             <ul className="space-y-3">
                <li><Link href="/services#web-development" className="text-gray-600 hover:text-black transition-colors">Web Development</Link></li>
                <li><Link href="/services#mobile-development" className="text-gray-600 hover:text-black transition-colors">Mobile Development</Link></li>
                <li><Link href="/services#software-development" className="text-gray-600 hover:text-black transition-colors">Software Development</Link></li>
                <li><Link href="/services#ui-ux" className="text-gray-600 hover:text-black transition-colors">UI/UX Development</Link></li>
                <li><Link href="/services#seo" className="text-gray-600 hover:text-black transition-colors">Search Engine Optimization</Link></li>
            </ul>
          </div>
          
          <div className="space-y-5">
             <h4 className="font-semibold text-base text-black">Newsletter</h4>
             <div className="relative w-full max-w-sm items-center">
                <Mail className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-400" />
                <Input type="email" placeholder="Your email address" className="bg-gray-100 border-gray-200 text-black placeholder:text-gray-500 focus:bg-white pl-10 pr-10 h-12" />
                <Button type="submit" size="icon" className="absolute right-2 top-1/2 -translate-y-1/2 bg-transparent hover:bg-gray-200 text-black h-8 w-8">
        ...
        <div className="mt-16 pt-8 border-t border-gray-200 flex flex-col sm:flex-row items-center justify-between text-xs text-gray-500">
