...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-[#023055] text-white border-t border-white/10 relative rounded-b-xl">
      <div className="container mx-auto py-12 px-5" suppressHydrationWarning={true}>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <Link href="/" className="flex items-center space-y-2 mb-4">
              <span className="text-2xl font-black italic text-white uppercase tracking-tighter">yellow<span className="text-accent">beam</span>tech</span>
            </Link>
            <p className="text-gray-300 max-w-sm text-sm">
              Welcome to yellowbeamtech! We provide diverse IT solutions with a team of experts. From IT management to cloud solutions, we have you covered.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-white/20 flex flex-col sm:flex-row items-center justify-between text-sm text-gray-400">
          <p className="mb-4 sm:mb-0">© 2026 Yellowbeamtech. All Rights Reserved.</p>
