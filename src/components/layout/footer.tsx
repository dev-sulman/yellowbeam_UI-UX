...
const SulzaXLogo = () => (
    <svg width="180" height="48" viewBox="0 0 1200 320" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="gBlueFooter" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0" stopColor="#05D1FF"/>
          <stop offset="1" stopColor="#0B52FF"/>
        </linearGradient>
        <filter id="softShadowFooter" x="-20%" y="-20%" width="140%" height="140%">
      ...
      <g transform="translate(60,30) scale(0.8)">
        <g filter="url(#softShadowFooter)">
            <circle cx="120" cy="130" r="92" fill="none" stroke="url(#gBlueFooter)" strokeWidth="18"/>
            <circle cx="120" cy="130" r="70" fill="none" stroke="url(#gBlueFooter)" strokeWidth="6" opacity="0.9"/>
            <g stroke="url(#gBlueFooter)" strokeWidth="8" strokeLinecap="round" fill="url(#gBlueFooter)">
       ...
       <text x="300" y="175"
        ...
        Sulza<tspan fill="url(#gBlueFooter)">X</tspan>
      </text>
    </svg>
);
